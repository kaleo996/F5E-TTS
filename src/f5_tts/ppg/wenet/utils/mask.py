...
#                chunk_size = chunk_size % 13 + 1 + 9  # [1,13]-->[10,22] no ds
#                chunk_size = chunk_size % 100 + 1  # [1,100] no ds
#                chunk_size = chunk_size % 25 + 1  #[1,25] 4 times ds

                #chunk_size = chunk_size % 6 + 1 + 2  #[1,6]-->[3,8] 4 times ds
                chunk_size = chunk_size % 7 + 1 + 4  #[1,7]-->[5,11] 2 times ds
